<template>
    <div class="max-w-sm rounded overflow-hidden shadow-lg shadow-gray-400 bg-white">
        <h4 class="text-center text-gray-600">Push Swap</h4>
        ...
        <div class="flex justify-end">
            <button class="mr-4 text-gray-400 text-center py-2 px-4 rounded">
                Read more
            </button>
            <img />
        </div>
...
<style>
    @import url('./../../assets/styles/projectsStyle.css');
</style>